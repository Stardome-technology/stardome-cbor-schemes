...
| stardome_attestation_schema_v1.0.0_0 | 1.0.0 | SGE |
| stardome_attestation_schema_v1.0.0_1 | 1.0.0 | SSP |
| stardome_attestation_schema_v2.0.0 | 2.0.0 | ALL |
| stardome_attestation_tree_schema_v1.0.0_0 | 1.0.0 | SGE |
| stardome_attestation_tree_schema_v1.0.0_1 | 1.0.0 | SSP |
| stardome_attestation_tree_schema_v2.0.0 | 2.0.0 | ALL |
| stardome_epoch_schema_v2.0.0 | 2.0.0 | ALL |
| stardome_host_id_response_schema_v1.0.0_0 | 1.0.0 | SGE |
| stardome_host_id_response_schema_v1.0.0_1 | 1.0.0 | SSP |
| stardome_host_id_response_schema_v2.0.0 | 2.0.0 | ALL |
| stardome_proof_request_schema_v1.0.0_0 | 1.0.0 | ALL |
| stardome_sign_request_schema_v1.0.0_0 | 1.0.0 | SGE |
| stardome_sign_request_schema_v1.0.0_1 | 1.0.0 | SSP |
...
In particular, `stardome_proof_request_schema_v1.0.0_*.cddl` requests should use **definite-length** CBOR containers (no indefinite-length arrays/maps/strings). Python `cbor2` emits definite-length CBOR by default.
